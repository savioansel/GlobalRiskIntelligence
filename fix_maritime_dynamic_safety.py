...
for i in range(start_idx, len(lines)):
    if "const BASE_RAIL_ROUTES:" in lines[i] or "function getRailRoute" in lines[i] or "const SAFE_RAIL_ROUTES:" in lines[i] or "export interface StationWaypoint" in lines[i]:
        end_idx = i
        break
